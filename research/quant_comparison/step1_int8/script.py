"""
QUANT COMPARISON -- Step 1: INT8 Weight Quantisation (W8A16)
=============================================================
Weights compressed from float16 (2 bytes) to int8 (1 byte).
...
def log(msg): print(f'[INT8] {msg}', flush=True)
...
metrics = {'step': 'int8', 'vram_peak_gb': round(vram_peak, 2),
           'inference_time_s': round(inf_time, 1), 'optimisations': 'int8_weights',
